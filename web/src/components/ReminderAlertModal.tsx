...
import { AppTask, Category } from '../types';
import { toPersianDigits } from '../calendar/jalali';
import { Bell, Check, Clock, Volume2, X, RotateCcw } from 'lucide-react';
      ...
      <div className="bg-white rounded-3xl max-w-md w-full shadow-2xl border-2 border-emerald-300 text-right overflow-hidden animate-scale-up">
        ...
        <div className="bg-gradient-to-l from-emerald-600 to-teal-700 text-white p-6 relative">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <h3 className="text-lg font-black tracking-tight text-white">زمان انجام تسک فرا رسید!</h3>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-4 text-xs">
          ...
          <p className="text-[11px] text-gray-500 text-center leading-relaxed">
            این یادآوری هم‌زمان از طریق اعلان مرورگر و پخش ملودی آرامش‌بخش بدون کلام اعلام شده است.
          </p>
          ...
          <div className="space-y-2 pt-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <span>۵ دقیقه بعد یادآوری کن</span>
              </button>

              <button
                type="button"
                onClick={onDismiss}
                className="py-2.5 px-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl flex items-center justify-center gap-1.5 transition-colors cursor-pointer text-xs"
              >
